...
import Arrivals from "@/app/components/arrivals/Arrivals";
import Rubashka from "../../assets/rubashka.png"
import { Oswald, League_Spartan } from "next/font/google"
import type { Metadata } from "next"

export const metadata: Metadata ={
  title: "Zamonaviy kiyimlar | aksessuarlar | Ayollar va Erkaklar kiyimi | SinglePage",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 justify-center lg:grid-cols-2 gap-3">
          ...
          <div className="flex flex-col">
            <h1 className={`${spartan.className}text-2xl lg:text-4xl font-bold text-gray-900 mb-3`}>
            ...
            {/* Description */}
            <p className={`${oswald.className}text-gray-600 leading-relaxed mb-6`}>
          ...
          <div className="py-6 sm:py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
              ...
              <div className="border border-gray-200 rounded-2xl p-4 sm:p-6 hover:shadow-md transition-shadow">
                ...
                <p className={`${oswald.className}text-gray-600 text-sm leading-relaxed mb-3 sm:mb-4`}>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 sm:hidden">
                    <h2 className={`${spartan.className} text-[32px] sm:text-[48px] font-[700] uppercase text-center my-[20px]`}>
                      You Might also like
                    </h2>
